...
class ThreadEx extends Thread{
	...
	@Override
	//위의 annotation은 상위 클래스나 인터페이스에서 제공하는 메서드가 아닌 경우 에러를 발생시켜주는 어노테이션이다
	public void run(){
...
public class ThreadCreate {
	...
	public static void main(String[] args) {
		...
		//Thread 클래스로부터 상속받은 클래스를 이용해서 스레드를 생성하고 실행(start)
